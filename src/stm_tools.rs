pub fn calculate_stm_tempo(tempo: u8) -> u8 {
    ...
    let factor_constants: [f32; 16] = [
        140.0, 50.0, 25.0, 15.0, 10.0, 7.0, 6.0, 4.0, 3.0, 3.0, 2.0, 2.0, 2.0, 2.0, 1.0, 1.0,
    ];
    let mut samples_per_tick: f32 =
        st_mixing_rate / (50.0 - ((factor_constants[st1_tpr] * st1_fac) / 16.0));
